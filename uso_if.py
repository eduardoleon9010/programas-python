...
Si es negativo, imprime un mensaje indicando que no es válido, guarda el valor original 
en una variable y, asigna el valor 42 a la variable x y luego muestra un mensaje indicando 
que se decidió usar 42 en lugar del número original y.
